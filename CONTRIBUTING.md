# Contributing to aetherhealth

Thank you for your interest in contributing to aetherhealth! This document provides guidelines and instructions for contributing to this project.
...
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/aetherhealth.git
   ```
...
By contributing to aetherhealth, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
